  ...
  translation: {
    ...
    discover: {
      ...
      list: {
        ...
        tool: {
          ...
          content: "·Based on powerful social networks and Crypto systems, we generate a unique identity for you.\n·Hypergram not only generates unique Crypto information for you, but also integrates your local information in a decentralized manner, completing a comprehensive AI shaping of your image.",
        },
      },
    },
    arch: {
    ...
    featList: {
      ...
      openAndFair: {
        title: "Community",
        content:
          "Hypergram builds a trusted and sustainable community based on AI technology.",
      },
    },
    footer: {
      intro:
        "Hypergram is a decentralized swapping ecosystem powered by social networks and AI technology, integrating decentralized social data with intelligent analysis to seamlessly connect swapping behaviors. Currently deeply compatible with the Telegram ecosystem to efficiently connect KOLs and retail investors, while featuring an open architecture for future multi-platform expansion.",
      dapps: {
        title: "DApps",
        iphone: "iPhone/iPad",
        android: "Android",
