export const zh = {
  translation: {
    ...
    discover: {
      title: "人们为什么选择Hypergram?",
      list: {
        quick: {
          title: "无缝衔接Telegram 好友和消息",
          content:
            "Hypergram是 Telegram 增强版,增加了对消息的AI分析能力,实时分析聊天信息。\n通过分析出于Crypto相关的信息，并且实时展示最新市场行情,让你一站式了解全貌。",
        },
        high: {
          title: "安全去中心管理资产",
          content: "所有私钥都在本地生成，只有你拥有你的私钥。\nHypergram绝对不会上传你的任何信息,包括私钥、聊天记录。",
        },
        sharing: {
          title: "快速洞察市场行情",
          content: "强大的后台支撑，行情急速同步。\nHypergram同时也会为你推荐市场火热的频道,让你更好获得市场信息。",
        },
        analysis: {
          title: "基于共识，驱动社区生态发展",
        ...
        tool: {
          ...
          content: "基于强大的社交网络和Crypto系统,我们为你生成独一无二的身份\nHypergram不只为你生成Crypto独一无二的信息,更能去中心化的整合你本地信息,完成对你形象的全方位AI塑造。",
        },
      },
    },
    arch: {
    ...
    featList: {
      ...
      openAndFair: {
        title: "社区",
        content:
          "Hypergram建立了一个基于AI技术的可信赖和可持续的社区。",
      },
    },
    footer: {
      intro:
        "Hypergram是一个由社交网络和AI技术驱动的去中心化交易生态系统，通过整合去中心化社交数据与智能分析，无缝连接交易行为。当前深度兼容Telegram生态，高效链接KOL与普通投资者，同时具备开放架构以支持未来多平台扩展。",
      dapps: {
        title: "DApps",
        iphone: "iPhone/iPad",
        android: "Android",
